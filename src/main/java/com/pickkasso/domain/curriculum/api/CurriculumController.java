...
public class CurriculumController {
    ...
    @GetMapping
    public List<UserCurriculumListViewResponse> findUserCurriculums(@AuthenticationPrincipal Member member) {
        List<UserCurriculumListViewResponse> userCurriculumListViewResponses = curriculumService.getUserCurriculums(member);
        return userCurriculumListViewResponses;
    }


    @GetMapping("/all")
    public List<AllCurriculumListViewResponse> findAllCurriculums(@AuthenticationPrincipal Member member) {
    ...
    @GetMapping("/{id}")
    public SelectedCurriculumResponse findCurriculum(@PathVariable long id, @AuthenticationPrincipal Member member) {

        SelectedCurriculumResponse selectedCurriculumResponse = curriculumService.getSelectedCurriculum(id, member);
